...
<head>
  ...
  <title>Instore Checkout</title>
  <link rel="stylesheet" type="text/css" href="style.css">
</head>

<body class="placeSOrder">
  <h1>Instore Checkout</h1>
	<%
  ...
  <form action="./controller.jsp" method="POST">
	...
	<div id="searchresult" align="center" >
		<form action="mancheckout.jsp" id="getQty" name= "checkout" method="GET">
      <%
      	...
      	for (int i = 0; i < vecResult.size(); i++) {
        	...
        	if (temp!=null){
        		int quan=Integer.parseInt(temp);
          		if (quan>0){
          			if (quan>Integer.parseInt(detail[4])){
          				info="We only have "+detail[4]+" "+detail[1]+" in store!";
          			}else{
          				total+=quan*Double.parseDouble(detail[3]);
            			dbcontroller.InsertIntoCart(""+detail[0], detail[1], ""+detail[3], ""+quan);
  ...
  <form action="./instoreconfirm.jsp" method="GET">
     <input type="submit" name="transfer" value="Check Out" >
  </form>
