...
<body class="onlineorder">
  ...
  <div id="searchresult" align="center" >
    ...
    out.write("<h1 style=\"color: #4CAF50;\">View all online order</h1>");
    out.write("<hr/>");
    ...
    Vector<String> vecResult = dbcontroller.FindOnlineOrders(); 
  ...
  content.append("<tr><th><u>Order Number</u>&nbsp;&nbsp;&nbsp;&nbsp;</th>" + 
    ...
    "<th><u>Quantity</u>&nbsp;&nbsp;&nbsp;&nbsp;</th>" +
    "<th><u>Price</u>&nbsp;&nbsp;&nbsp;&nbsp;</th><th><u>Purchase Date</u></th><th><u>Type</u>&nbsp;&nbsp;&nbsp;&nbsp;</th><th><u>PickUpDate</u>&nbsp;&nbsp;&nbsp;&nbsp;</th></tr>");
    ...
    if (detail.length != 8) {
          ...
          content.append("<td>" + detail[6].substring(0,10) + "</td>" );
